    ...
    <>
      <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-slate-300 bg-slate-800 px-6 pb-4">
            <div className="flex h-16 shrink-0 items-center">
              <img
                alt="Bree Logo"
                src="/assets/images/bree-logo.png"
        ...
        <div className="lg:pl-72">
          <div className="sticky top-0 z-40 flex h-16 shrink-0 justify-between items-center gap-x-4 border-b border-slate-200 bg-slate-800 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            <div>
              <button
                type="button"
